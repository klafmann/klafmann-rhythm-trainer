...
function quarterRestImage(x,y,cls=''){
  // Wikimedia Commons quarter rest image; scaled to match quarter-note visual height.
...
function start(){
  ...
  interval=setInterval(tick,beatMs);
  tick();
}
...
function updateStageText(){
  if(phase==='demo'){
    ...
    stageTitle.innerHTML='<b>輪到你拍</b>｜Your turn';
